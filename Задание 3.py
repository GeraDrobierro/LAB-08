...
while True:
    while True:
        ...
        if len(contr) > 0:
            ...
            if x > frame.shape[1] / 2:  # проверяем находиться ли метка по координате x в правой части экрана
                cv2.putText(frame, 'POPAL', (10, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)  # пишем текст
